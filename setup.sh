...
#Edu
wget https://raw.githubusercontent.com/indotunnel/inc/main/websocket/websocket.sh && chmod +x websocket.sh && ./websocket.sh
wget https://raw.githubusercontent.com/indotunnel/inc/main/websocket/edu.sh && chmod +x edu.sh && screen -S edu ./edu.sh
rm -f /root/edu.sh
...
echo "   - OpenVPN                 : TCP 1194, UDP 1194, SSL 442"  | tee -a log-install.txt
